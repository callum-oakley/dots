...
BindPR({ "alt", "shift" }, "h", hs.grid.resizeWindowThinner)
BindPR({ "alt", "shift" }, "j", hs.grid.resizeWindowTaller)
BindPR({ "alt", "shift" }, "k", hs.grid.resizeWindowShorter)
BindPR({ "alt", "shift" }, "l", hs.grid.resizeWindowWider)
BindPR({ "alt", "shift" }, "f", SnapWindow)
